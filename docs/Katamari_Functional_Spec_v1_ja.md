...
- **注記（2025-10-23 更新）**：現行リリースでは `/healthz`・`/metrics` の Bearer 認証のみが有効であり、Chainlit UI 本体は引き続き無認証です。M1.5 で OAuth を導入後、本注記を更新します。導入タスクは [`TASK.2025-10-19-0002.md`](tasks/TASK.2025-10-19-0002.md) を参照。
