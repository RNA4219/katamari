...
const RECONNECTION_BACKOFF_FACTOR = 2;
const RECONNECTION_MAX_DELAY_MS =
  RECONNECTION_BASE_DELAY_MS * RECONNECTION_BACKOFF_FACTOR ** (RECONNECTION_ATTEMPTS - 1);

export const SOCKET_IO_RECONNECTION_ATTEMPTS = RECONNECTION_ATTEMPTS;
export const SOCKET_IO_BACKOFF_FACTOR = RECONNECTION_BACKOFF_FACTOR;
export const SOCKET_IO_RECONNECTION_OPTIONS = {
  reconnectionAttempts: RECONNECTION_ATTEMPTS,
  reconnectionDelay: RECONNECTION_BASE_DELAY_MS,
  reconnectionDelayMax: RECONNECTION_MAX_DELAY_MS,
